...
from tf_ops import (batch_norm, concat, conv2d, conv_cond_concat,
                    conv_out_size_same, deconv2d, linear, lrelu)
from utils import (get_image, image_manifold_size, save_images)
